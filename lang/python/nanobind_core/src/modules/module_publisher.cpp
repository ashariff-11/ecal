...
void AddPublisherClassToModule(const nanobind::module_& module) 
{
    ...
    auto Publisher_cls = nanobind::class_<eCAL::CNBPublisher>(module, "Publisher")
        ...
        .def("send", [](eCAL::CNBPublisher& self, void* buffer, size_t len)->size_t {return self.Send(buffer, len); })
        ...
        .def("send", [](eCAL::CNBPublisher& self, const std::string& buffer)->size_t {return self.Send(buffer); })
